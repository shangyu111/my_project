...
<div class="content" :style='{"minHeight":"calc(100vh - 190px)","padding":"0px 5% 30px","margin":"0 auto","alignItems":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230909/c30ce7be70a7441f82674cbbf06daef2.jpg) no-repeat center top / cover","display":"flex","width":"100%","fontSize":"16px","height":"100%"}'>
	...
	<!-- statis -->
	<div :style='{"padding":"0 0%","boxShadow":"0 0px 0px 0px rgba(100,100,100,.05)","margin":"0 0px 30px 0px","borderColor":"#fceaee","alignItems":"center","color":"#8e99a2","display":"flex","justifyContent":"center","borderRadius":"3px","flexWrap":"wrap","background":"none","borderWidth":"0px","width":"100%","fontSize":"16px","borderStyle":"double","order":"1"}'>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","padding":"0 10px 0 0","margin":"0 2% 10px 0","borderColor":"#f6f6f6","borderRadius":"3px","textAlign":"center","background":"#fff","borderWidth":"2px","display":"flex","width":"18%","borderStyle":"solid","justifyContent":"center"}' v-if="isAuth('jiaoshi','首页总数')">
			<div :style='{"alignItems":"center","background":"none","display":"flex","width":"80px","justifyContent":"flex-end","height":"100px","order":"2"}'>
				<span class="icon iconfont icon-zhangjie7" :style='{"color":"#dbe7fa","fontSize":"42px"}'></span>
			</div>
			<div :style='{"width":"auto","flexDirection":"column-reverse","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","color":"#4b88e4","textAlign":"left","lineHeight":"24px","fontSize":"28px","fontWeight":"600","height":"24px"}'>{{jiaoshiCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"inherit","color":"inherit","height":"24px"}'>教师总数</div>
			</div>
		</div>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","padding":"0 10px 0 0","margin":"0 2% 10px 0","borderColor":"#f6f6f6","borderRadius":"3px","textAlign":"center","background":"#fff","borderWidth":"2px","display":"flex","width":"18%","borderStyle":"solid","justifyContent":"center"}' v-if="isAuth('xuesheng','首页总数')">
			<div :style='{"alignItems":"center","background":"none","display":"flex","width":"80px","justifyContent":"flex-end","height":"100px","order":"2"}'>
				<span class="icon iconfont icon-zhangjie8" :style='{"color":"#fcdde2","fontSize":"42px"}'></span>
			</div>
			<div :style='{"width":"auto","flexDirection":"column-reverse","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","color":"#f1556c","textAlign":"left","lineHeight":"24px","fontSize":"32px","fontWeight":"bold","height":"24px"}'>{{xueshengCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"inherit","color":"inherit","height":"24px"}'>学生总数</div>
			</div>
		</div>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","padding":"0 10px 0 0","margin":"0 2% 10px 0","borderColor":"#f6f6f6","borderRadius":"3px","textAlign":"center","background":"#fff","borderWidth":"2px","display":"flex","width":"18%","borderStyle":"solid","justifyContent":"center"}' v-if="isAuth('qiandaojilu','首页总数')">
			<div :style='{"alignItems":"center","background":"none","display":"flex","width":"80px","justifyContent":"flex-end","height":"100px","order":"2"}'>
				<span class="icon iconfont icon-zhangjie7" :style='{"color":"#cceef3","fontSize":"42px"}'></span>
			</div>
			<div :style='{"width":"auto","flexDirection":"column-reverse","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","color":"#00acc1","textAlign":"left","lineHeight":"24px","fontSize":"32px","fontWeight":"bold","height":"24px"}'>{{qiandaojiluCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"inherit","color":"inherit","height":"24px"}'>签到记录总数</div>
			</div>
		</div>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","padding":"0 10px 0 0","margin":"0 2% 10px 0","borderColor":"#f6f6f6","borderRadius":"3px","textAlign":"center","background":"#fff","borderWidth":"2px","display":"flex","width":"18%","borderStyle":"solid","justifyContent":"center"}' v-if="isAuth('qingjiajilu','首页总数')">
			<div :style='{"alignItems":"center","background":"none","display":"flex","width":"80px","justifyContent":"flex-end","height":"100px","order":"2"}'>
				<span class="icon iconfont icon-zhangjie8" :style='{"color":"#9973c250","fontSize":"42px"}'></span>
			</div>
			<div :style='{"width":"auto","flexDirection":"column-reverse","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","color":"#9973c2","textAlign":"left","lineHeight":"24px","fontSize":"32px","fontWeight":"bold","height":"24px"}'>{{qingjiajiluCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"inherit","color":"inherit","height":"24px"}'>请假记录总数</div>
			</div>
		</div>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.0)","padding":"0","margin":"0 0px 10px 0","borderColor":"#f6f6f6","borderRadius":"3px","textAlign":"center","background":"#fff","borderWidth":"2px","display":"flex","width":"20%","borderStyle":"solid","justifyContent":"center"}' v-if="isAuth('kaoqintongji','首页总数')">
			<div :style='{"alignItems":"center","background":"none","display":"flex","width":"80px","justifyContent":"flex-end","height":"100px","order":"2"}'>
				<span class="icon iconfont icon-zhangjie7" :style='{"color":"#16a08550","fontSize":"32px"}'></span>
			</div>
			<div :style='{"width":"auto","flexDirection":"column-reverse","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","color":"#16a085","textAlign":"left","lineHeight":"24px","fontSize":"32px","fontWeight":"bold","height":"24px"}'>{{kaoqintongjiCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"inherit","color":"inherit","height":"24px"}'>考勤统计总数</div>
			</div>
		</div>
	</div>
	<!-- statis -->
	...
	<!-- echarts -->
	<!-- 3 -->
	<div class="type3" :style='{"alignContent":"flex-start","padding":"0","borderRadius":"8px","flexWrap":"wrap","background":"none","flex":"1","display":"flex","width":"calc(100% - 580px)","position":"relative","justifyContent":"space-between","height":"auto","order":"3"}'>
		<div id="qiandaojiluChart1" class="echarts1" v-if="isAuth('qiandaojilu','首页统计')"></div>
		<div id="qingjiajiluChart1" class="echarts2" v-if="isAuth('qingjiajilu','首页统计')"></div>
		<div id="kaoqintongjiChart1" class="echarts3" v-if="isAuth('kaoqintongji','首页统计')"></div>
	</div>
</div>
</template>
<script>
...
export default {
	...
	mounted(){
		...
		this.getqiandaojiluCount();
		this.qiandaojiluChat1();
		this.getqingjiajiluCount();
		this.qingjiajiluChat1();
		this.getkaoqintongjiCount();
		this.kaoqintongjiChat1();
	},
	methods:{
		// 词云
		...
		getqiandaojiluCount() {
			this.$http({
				url: `qiandaojilu/count`,
				method: "get"
			}).then(({
				data
			}) => {
				if (data && data.code == 0) {
					this.qiandaojiluCount = data.data
				}
			})
		},
		qiandaojiluChat1() {
        ...
        var qiandaojiluChart1 = echarts.init(document.getElementById("qiandaojiluChart1"),'macarons');
        this.$http({
            url: "qiandaojilu/group/kechengmingcheng",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                qiandaojiluChart1.setOption(option);
				// 动画效果
				this.myChartInterval(1, option.xAxis.data, option.series[0].data, qiandaojiluChart1)
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    qiandaojiluChart1.resize();
                };
            }
        });
      })
		...
		getqingjiajiluCount() {
			this.$http({
				url: `qingjiajilu/count`,
				method: "get"
			}).then(({
				data
			}) => {
				if (data && data.code == 0) {
					this.qingjiajiluCount = data.data
				}
			})
		},
		qingjiajiluChat1() {
        ...
        var qingjiajiluChart1 = echarts.init(document.getElementById("qingjiajiluChart1"),'macarons');
        this.$http({
            url: "qingjiajilu/group/xuehao",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                qingjiajiluChart1.setOption(option);
				// 动画效果
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    qingjiajiluChart1.resize();
                };
            }
        });
      })
		...
		getkaoqintongjiCount() {
			this.$http({
				...
				if (data && data.code == 0) {
					this.kaoqintongjiCount = data.data
				}
			})
		},
		kaoqintongjiChat1() {
        ...
        var kaoqintongjiChart1 = echarts.init(document.getElementById("kaoqintongjiChart1"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                kaoqintongjiChart1.setOption(option);
				// 动画效果
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    kaoqintongjiChart1.resize();
                };
            }
        });
      })
