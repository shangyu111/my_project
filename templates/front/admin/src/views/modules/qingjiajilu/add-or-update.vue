	...
	<div class="addEdit-block" :style='{"minHeight":"calc(100vh - 200px)","padding":"0px 0 30px","margin":"0 auto","color":"#8e99a2","background":"none","width":"calc(100% - 0px)","fontSize":"14px","height":"100%"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 20px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' class="date" v-if="type!='info'" label="请假时间" prop="qingjiashijian">
					<el-date-picker
				...
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 20px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' class="input" v-else-if="ruleForm.qingjiashijian" label="请假时间" prop="qingjiashijian">
					<el-input v-model="ruleForm.qingjiashijian" placeholder="请假时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 20px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="请假原因" prop="qingjiayuanyin">
					<el-input v-model="ruleForm.qingjiayuanyin" placeholder="请假原因" clearable  :readonly="ro.qingjiayuanyin"></el-input>
				</el-form-item>
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 20px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' v-else class="input" label="请假原因" prop="qingjiayuanyin">
					<el-input v-model="ruleForm.qingjiayuanyin" placeholder="请假原因" readonly></el-input>
				</el-form-item>
